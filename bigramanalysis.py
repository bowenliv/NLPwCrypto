...
input_file = "rawdata/Tesla_NeutralV3.csv"
tesla_bigram = "rawdata/Unigram_Neutral_teslaV3.csv"
topN_to_show = 20

tweets = read_and_clean_lines(input_file)
stopwords = load_stopwords(stopwords_file)
print("\nGetting tesla unigram and bigram counts")
tesla_bigram_counts = collect_bigram_counts(tweets['tweet_text'], stopwords, False)
print("\nTop tesla bigrams by frequency")
(KEY, VALUE) = print_sorted_items(tesla_bigram, tesla_bigram_counts, topN_to_show, 'descending')
plt.barh(KEY,VALUE)
plt.show()